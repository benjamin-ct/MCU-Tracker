...
// INFO[id].cast n'affiche que 2-3 noms principaux dans la fiche (place limitée) —
// mais la recherche par acteur doit trouver TOUS les rôles (secondaires, apparitions),
// pas seulement ceux affichés. CAST_EXTRA n'est donc jamais rendu à l'écran, seulement
// consulté par matchSearch() (js/compute.js). Recherché/vérifié séparément par titre.
const CAST_EXTRA={
  cap1:"Tommy Lee Jones, Hugo Weaving, Stanley Tucci, Dominic Cooper, Toby Jones, Neal McDonough, Derek Luke, Samuel L. Jackson",
  capmarvel:"Ben Mendelsohn, Djimon Hounsou, Lee Pace, Lashana Lynch, Gemma Chan, Annette Bening, Clark Gregg",
  ironman1:"Terrence Howard, Shaun Toub, Jon Favreau, Clark Gregg, Leslie Bibb",
  ironman2:"Don Cheadle, Sam Rockwell, Scarlett Johansson, Samuel L. Jackson, Clark Gregg, Garry Shandling",
  hulk:"William Hurt, Tim Blake Nelson, Ty Burrell",
  thor1:"Anthony Hopkins, Stellan Skarsgård, Kat Dennings, Idris Elba, Rene Russo, Colm Feore, Jaimie Alexander, Samuel L. Jackson",
  avengers1:"Tom Hiddleston, Jeremy Renner, Mark Ruffalo, Samuel L. Jackson, Cobie Smulders, Clark Gregg, Stellan Skarsgård, Gwyneth Paltrow",
  thor2:"Anthony Hopkins, Stellan Skarsgård, Kat Dennings, Idris Elba, Rene Russo, Christopher Eccleston, Zachary Levi, Jaimie Alexander",
  ironman3:"Don Cheadle, Guy Pearce, Rebecca Hall, Jon Favreau",
  cap2:"Samuel L. Jackson, Anthony Mackie, Robert Redford, Frank Grillo, Cobie Smulders, Emily VanCamp",
  gotg1:"Vin Diesel, Bradley Cooper, Lee Pace, Karen Gillan, Djimon Hounsou, Michael Rooker, Benicio del Toro, Glenn Close, John C. Reilly",
  gotg2:"Michael Rooker, Karen Gillan, Sylvester Stallone, Pom Klementieff, Elizabeth Debicki, Chris Sullivan, Sean Gunn, Dave Bautista",
  avengers2:"Mark Ruffalo, Chris Hemsworth, Jeremy Renner, Scarlett Johansson, James Spader, Samuel L. Jackson, Paul Bettany, Cobie Smulders, Anthony Mackie, Don Cheadle",
  dd_s1:"Rosario Dawson, Elden Henson, Toby Leonard Moore, Bob Gunton, Scott Glenn, Vondie Curtis-Hall",
  jj_s1:"Mike Colter, Carrie-Anne Moss, Wil Traval, Erin Moriarty, Eka Darville",
  antman1:"Corey Stoll, Bobby Cannavale, Judy Greer, Michael Peña, Anthony Mackie, T.I.",
  cap3:"Sebastian Stan, Anthony Mackie, Don Cheadle, Jeremy Renner, Paul Bettany, Elizabeth Olsen, Paul Rudd, Emily VanCamp, Chadwick Boseman, Tom Holland",
  dd_s2:"Deborah Ann Woll, Elden Henson, Vincent D'Onofrio, Rosario Dawson, Stephen Rider",
  lc_s1:"Alfre Woodard, Theo Rossi, Frank Whaley, Rosario Dawson, Erik LaRay Harvey, Frankie Faison",
  blackwidow:"Rachel Weisz, William Hurt, Ray Winstone, O-T Fagbenle",
  blackpanther1:"Danai Gurira, Martin Freeman, Daniel Kaluuya, Letitia Wright, Winston Duke, Angela Bassett, Forest Whitaker, Andy Serkis",
  spiderman1:"Zendaya, Jacob Batalon, Marisa Tomei, Jon Favreau, Donald Glover, Tyne Daly, Bokeem Woodbine",
  drstrange1:"Rachel McAdams, Mads Mikkelsen, Benedict Wong",
  thor3:"Idris Elba, Jeff Goldblum, Tessa Thompson, Karl Urban, Mark Ruffalo, Anthony Hopkins, Benedict Cumberbatch",
  if_s1:"David Wenham, Tom Pelphrey, Rosario Dawson, Sacha Dhawan",
  defenders:"Rosario Dawson, Elden Henson, Deborah Ann Woll, Élodie Yung, Sigourney Weaver, Jessica Henwick",
  pun_s1:"Ebon Moss-Bachrach, Amber Rose Revah, Daniel Webber, Paul Schulze, Jason R. Moore",
  avengers3:"Chris Evans, Scarlett Johansson, Benedict Cumberbatch, Chadwick Boseman, Tom Holland, Elizabeth Olsen, Paul Bettany, Anthony Mackie, Sebastian Stan, Zoe Saldaña",
  jj_s2:"Carrie-Anne Moss, Eka Darville, J.R. Ramirez, David Tennant",
  lc_s2:"Simone Missick, Theo Rossi, Rosario Dawson, Gabrielle Dennis",
  if_s2:"Tom Pelphrey, Alice Eve, Sacha Dhawan",
  dd_s3:"Elden Henson, Deborah Ann Woll, Wilson Bethel, Joanne Whalley",
  antman2:"Michael Peña, Hannah John-Kamen, Walton Goggins, Laurence Fishburne, Randall Park, Judy Greer, Bobby Cannavale",
  pun_s2:"Josh Stewart, Giorgia Whigham, Corbin Bernsen, Deborah Ann Woll",
  jj_s3:"Eka Darville, Carrie-Anne Moss, J.R. Ramirez",
  avengers4:"Mark Ruffalo, Chris Hemsworth, Jeremy Renner, Don Cheadle, Paul Rudd, Karen Gillan, Danai Gurira, Josh Brolin, Benedict Cumberbatch, Brie Larson",
  wandavision:"Randall Park, Kat Dennings, Teyonah Parris, Josh Stamberg",
  falcon:"Daniel Brühl, Emily VanCamp, Erin Kellyman, Georges St-Pierre",
  loki1:"Gugu Mbatha-Raw, Wunmi Mosaku, Eugene Cordero",
  whatif1:"Hayley Atwell, Samuel L. Jackson, Josh Keaton, Mick Wingert, Chris Hemsworth, Benedict Cumberbatch, Chadwick Boseman, Michael Douglas, Lake Bell",
  farfromhome:"Zendaya, Jacob Batalon, Marisa Tomei, Cobie Smulders, Jon Favreau, JB Smoove, Numan Acar",
  hawkeye:"Florence Pugh, Fra Fee, Alaqua Cox, Tony Dalton",
  moonknight:"Gaspard Ulliel, F. Murray Abraham, Karim El Hakim",
  eternals:"Kit Harington, Salma Hayek, Lauren Ridloff, Brian Tyree Henry, Barry Keoghan, Don Lee, Lia McHugh, Kumail Nanjiani",
  msmarvel:"Zenobia Shroff, Mohan Kapoor, Saagar Shaikh, Rish Shah",
  nowayhome:"Benedict Cumberbatch, Jacob Batalon, Alfred Molina, Jamie Foxx, Marisa Tomei, Andrew Garfield, Tobey Maguire",
  drstrange2:"Chiwetel Ejiofor, Rachel McAdams, Benedict Wong, Michael Stuhlbarg",
  thor4:"Tessa Thompson, Russell Crowe, Jaimie Alexander, Taika Waititi",
  shehulk:"Ginger Gonzaga, Jameela Jamil, Renée Elise Goldsberry, Josh Segarra, Benedict Wong",
  wakandaforever:"Winston Duke, Angela Bassett, Danai Gurira, Martin Freeman, Dominique Thorne, Michaela Coel",
  secretinvasion:"Cobie Smulders, Kingsley Ben-Adir, Emilia Clarke, Don Cheadle, Martin Freeman",
  loki2:"Ke Huy Quan, Jonathan Majors, Gugu Mbatha-Raw, Wunmi Mosaku",
  whatif2:"Hayley Atwell, Chris Hemsworth, Lake Bell, Cate Blanchett, Jude Law, John Slattery, Michael Douglas",
  quantumania:"Kathryn Newton, Michael Douglas, Michelle Pfeiffer, Bill Murray, William Jackson Harper, Katy O'Brian",
  gotg3:"Karen Gillan, Pom Klementieff, Dave Bautista, Vin Diesel, Sean Gunn, Will Poulter, Elizabeth Debicki, Maria Bakalova, Chukwudi Iwuji",
  marvels:"Zawe Ashton, Samuel L. Jackson, Park Seo-joon",
  echo:"Devery Jacobs, Tantoo Cardinal, Zahn McClarnon, Cody Lightning, Charlie Cox",
  "xmen97-1":"Ross Marquand, Matthew Waterson, Ray Chase, Jennifer Hale, Alison Sealy-Smith, Cal Dodd, Lenore Zann, George Buza",
  xmen1:"Famke Janssen, James Marsden, Halle Berry, Anna Paquin, Rebecca Romijn, Ray Park, Tyler Mane, Bruce Davison",
  x2:"Famke Janssen, James Marsden, Halle Berry, Anna Paquin, Alan Cumming, Brian Cox, Rebecca Romijn",
  xlaststand:"James Marsden, Anna Paquin, Kelsey Grammer, Rebecca Romijn, Ellen Page, Ben Foster",
  xorigins:"Danny Huston, will.i.am, Lynn Collins, Taylor Kitsch, Dominic Monaghan",
  xfirstclass:"Kevin Bacon, Rose Byrne, January Jones, Nicholas Hoult, Zoë Kravitz",
  thewolverine:"Hiroyuki Sanada, Svetlana Khodchenkova, Famke Janssen",
  xdofp:"Ian McKellen, Patrick Stewart, Halle Berry, Nicholas Hoult, Ellen Page, Peter Dinklage, Evan Peters, Omar Sy",
  dp1:"T.J. Miller, Gina Carano, Brianna Hildebrand, Stefan Kapicic, Karan Soni, Leslie Uggams",
  xapocalypse:"Jennifer Lawrence, Nicholas Hoult, Rose Byrne, Sophie Turner, Evan Peters, Olivia Munn",
  logan:"Boyd Holbrook, Stephen Merchant, Richard E. Grant, Elizabeth Rodriguez",
  dp2:"Morena Baccarin, T.J. Miller, Brianna Hildebrand, Julian Dennison, Terry Crews, Karan Soni, Leslie Uggams",
  darkphoenix:"Jessica Chastain, Alexandra Shipp, Tye Sheridan, Nicholas Hoult, Evan Peters",
  newmutants:"Henry Zaga, Blu Hunt, Alice Braga",
  deadpoolwolverine:"Morena Baccarin, Rob Delaney, Leslie Uggams, Karan Soni, Matthew Macfadyen, Dafne Keen",
  agatha:"Patti LuPone, Debra Jo Rupp, Sasheer Zamata, Ali Ahn, Maria Dizzia",
  whatif3:"Anthony Mackie, Mark Ruffalo, Teyonah Parris, Sebastian Stan, David Harbour, Simu Liu, Oscar Isaac, Kathryn Hahn, Seth Green",
  yfns1:"Kari Wahlgren, Eugene Byrd, Zeno Robinson, Colman Domingo, Hugh Dancy, Charlie Cox, Roger Craig Smith",
  bravenewworld:"Shira Haas, Tim Blake Nelson, Carl Lumbly, Giancarlo Esposito, Liv Tyler, Xosha Roquemore",
  daredevil1:"Margarita Levieva, Deborah Ann Woll, Elden Henson, Wilson Bethel, Zabryna Guevara, Nikki M. James, Genneya Walton, Arty Froushan, Michael Gandolfini, Ayelet Zurer",
  thunderbolts:"Wyatt Russell, Olga Kurylenko, Lewis Pullman, Geraldine Viswanathan, Hannah John-Kamen, Julia Louis-Dreyfus, Wendell Pierce",
  ironheart:"Lyric Ross, Alden Ehrenreich, Regan Aliyah, Manny Montana, Anji White",
  fantasticfour:"Ebon Moss-Bachrach, Julia Garner, Natasha Lyonne, Paul Walter Hauser, Ralph Ineson",
  eyesofwakanda:"Winnie Harlow, Cress Williams, Anika Noni Rose, Steve Toussaint, Patricia Belcher, Lynn Whitfield",
  marvelzombies:"Iman Vellani, Hailee Steinfeld, Dominique Thorne, Florence Pugh, David Harbour, Simu Liu, Elizabeth Olsen, Randall Park, Awkwafina",
  wonderman:"Demetrius Grosse, X Mayo, Zlatko Burić, Arian Moayed, Olivia Thirlby, Josh Gad, Ed Harris",
  daredevil2:"Wilson Bethel, Deborah Ann Woll, Margarita Levieva, Matthew Lillard, Lili Taylor, Michael Gandolfini, Nikki M. James, Arty Froushan, Krysten Ritter",
  punisher:"Deborah Ann Woll, Jason R. Moore",
  "xmen97-2":"Ross Marquand, Matthew Waterson, Ray Chase, Jennifer Hale, Alison Sealy-Smith, Cal Dodd, Zehra Fazal, Gates McFadden, Michael Dorn, John de Lancie",
  brandnewday:"Zendaya, Sadie Sink, Jacob Batalon, Tramell Tillman, Michael Mando, Liza Colón-Zayas, Marvin Jones III",
  yfns2:"Grace Song, Zeno Robinson, Hugh Dancy, Charlie Cox, Colman Domingo, Kari Wahlgren, Eugene Byrd",
  visionquest:"James D'Arcy, Orla Brady, Emily Hampshire, Ruaridh Mollica",
  doomsday:"Chris Hemsworth, Anthony Mackie, Paul Rudd, Florence Pugh, Sebastian Stan, Chris Evans, Pedro Pascal, Vanessa Kirby, Patrick Stewart, Ian McKellen",
};
