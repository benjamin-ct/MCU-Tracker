...
export const INFO: Record<string, InfoEntry> = {
  ...
  ironman1: {
    synopsis:
      "Un industriel de l'armement, retenu captif, construit une armure motorisée pour s'échapper et devenir un héros.",
  ...
  ironman2: {
    synopsis:
      'Tony Stark doit affronter les conséquences de son identité publique et un nouvel ennemi armé de fouets électriques.',
    director: 'Jon Favreau',
  ...
  thor1: {
    synopsis:
      "Banni sur Terre par son père, le dieu du tonnerre doit apprendre l'humilité pour retrouver ses pouvoirs.",
  ...
  ironman3: {
    synopsis:
      "Après l'attaque de New York, Tony Stark affronte le terroriste Mandarin tout en luttant contre l'anxiété.",
  ...
  cap2: {
    synopsis:
      "Captain America découvre qu'HYDRA a infiltré le SHIELD alors qu'un mystérieux assassin, le Soldat de l'hiver, le traque.",
  ...
  gotg1: {
    synopsis:
      "Un groupe de renégats de l'espace s'allie pour empêcher un fanatique de mettre la main sur un orbe surpuissant.",
    director: 'James Gunn',
  ...
  gotg2: {
    synopsis:
      "Les Gardiens affrontent une nouvelle menace tandis que Peter Quill découvre l'identité de son père céleste.",
    director: 'James Gunn',
  ...
  avengers2: {
    synopsis:
      "Tony Stark crée une intelligence artificielle censée protéger le monde, mais Ultron se retourne contre l'humanité.",
    director: 'Joss Whedon',
  ...
  antman1: {
    synopsis:
      'Un cambrioleur repenti enfile une combinaison lui permettant de rétrécir pour réaliser un casse crucial.',
  ...
  thor3: {
    synopsis:
      "Thor, prisonnier sur Sakaar, doit combattre son ami Hulk dans l'arène pour sauver Asgard de sa sœur Hela.",
  ...
  pun_s1: {
    synopsis:
      'Frank Castle mène une guerre solitaire et sanglante contre le crime organisé après le meurtre de sa famille.',
  ...
  dd_s3: {
    synopsis:
      'Daredevil, laissé pour mort, doit reconstruire son identité tandis que le Caïd prend le contrôle du FBI.',
  ...
  marvels: {
    synopsis:
      "Carol Danvers, Kamala Khan et Monica Rambeau échangent involontairement de place lorsqu'elles utilisent leurs pouvoirs.",
  ...
  'xmen97-1': {
    synopsis:
      'Après la disparition du Professeur X, les X-Men doivent continuer son rêve dans un monde plus hostile que jamais.',
  ...
  xmen1: {
    synopsis:
      "Le Professeur Xavier et Magneto s'affrontent sur la meilleure façon de protéger les mutants d'un monde hostile.",
  ...
  xfirstclass: {
    synopsis:
      'Dans les années 1960, un jeune Charles Xavier et Erik Lehnsherr forment ensemble la première classe de mutants.',
  ...
  logan: {
    synopsis:
      'Un Wolverine vieillissant protège une jeune mutante aux pouvoirs similaires aux siens dans un futur sombre.',
    director: 'James Mangold',
  ...
  newmutants: {
    synopsis:
      'Un groupe de jeunes mutants internés dans un hôpital psychiatrique isolé doit affronter ses propres démons.',
    director: 'Josh Boone',
  ...
  agatha: {
    synopsis:
      'Libérée du sortilège de Wanda, Agatha Harkness forme un covent de sorcières pour reprendre ses pouvoirs.',
  ...
  bravenewworld: {
    synopsis:
      'Sam Wilson, nouveau Captain America, doit déjouer un complot international impliquant le président Ross.',
  ...
  fantasticfour: {
    synopsis:
      'Sur une Terre rétro-futuriste alternative, la première famille de Marvel affronte Galactus, dévoreur de mondes.',
    director: 'Matt Shakman',
  ...
  'xmen97-2': {
    synopsis:
      "Les X-Men affrontent de nouvelles menaces alors que les tensions entre humains et mutants s'intensifient.",
    director: 'Jake Castorena (showrunner)',
    cast: 'Voix de la série animée originale des années 90',
    budget: 'N/A',
    box: 'N/A',
  ...
  visionquest: {
    synopsis:
      'Vision, reconstruit et hanté par ses souvenirs, doit affronter Ultron pour retrouver qui il est vraiment.',
  ...
  doomsday: {
    synopsis:
      "Les héros de la Terre s'unissent face à la menace ultime d'un multivers en train de s'effondrer sous Doctor Doom.",
    director: 'Anthony et Joe Russo',
...
export const INFO_EN: Record<string, InfoOverride> = {
  ...
  cap2: {
    synopsis:
      'Captain America discovers HYDRA has infiltrated S.H.I.E.L.D. while a mysterious assassin, the Winter Soldier, hunts him.',
  ...
  avengers2: {
    synopsis:
      'Tony Stark creates an artificial intelligence meant to protect the world, but Ultron turns against humanity.',
  ...
  dd_s2: {
    synopsis:
      'Daredevil faces off against the Kingpin and crosses paths with the Punisher, while Elektra resurfaces from his past.',
  ...
  marvels: {
    synopsis:
      'Carol Danvers, Kamala Khan, and Monica Rambeau involuntarily swap places whenever they use their powers.',
